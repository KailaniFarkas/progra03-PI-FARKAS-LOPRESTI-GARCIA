        ...
        <section className="row">
          <section className="col-md-6 info">
            ...
            <p className="mt-0 mb-0" id="release-date">
              ...
              {this.state.serie.first_air_date}
            </p>
            <p className="mt-0 mb-0" id="episodes">
              <strong>Número de capítulos: </strong>
              {this.state.serie.number_of_episodes}
            </p>
            <p className="mt-0 seasons">
              <strong>Temporadas: </strong>
              {this.state.serie.number_of_seasons}
            </p>
            ...
            <p className="mt-0 mb-0">
              ...
              {this.state.serie.genres
                ? this.state.serie.genres.map((g) => g.name).join(", ")
                : "Cargando..."}
            </p>
          ...
          <img
            className="col-md-6"
            src={
              "https://image.tmdb.org/t/p/w500" + this.state.serie.poster_path
            }
