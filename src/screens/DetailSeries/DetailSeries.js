...
class DetailSerie extends Component {
  ...
  render() {
    console.log(this.state.serie);
      return (
        <div>
          <h2 className="alert alert-warning">{this.state.serie.title}</h2>
          <section className="row">
            <section className="col-md-6 info">
                <h3>Descripción</h3>
                <p className="description">{this.state.serie.overview}</p>
                <p className="mt-0 mb-0" id="release-date">
                  <strong>Fecha de estreno:</strong> {this.state.serie.release_date}
                </p>
                <p className="mt-0 mb-0" id="episodes">
                  <strong>Número de capítulos:</strong>{this.state.serie.numer_of_episodes}
                </p>
                <p className="mt-0 seasons">
                  <strong>Temporadas:</strong>{this.state.serie.numer_of_seasons}
                </p>
